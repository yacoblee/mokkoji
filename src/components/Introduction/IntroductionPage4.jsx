      ...
      <div className='mapAndhour'>
        ...
        <div className='hour'>
          <div className='operatinghours'>
            <div>
              <h2>관람시간</h2>
              <p><span className='highlight'>월, 화, 목, 금, 일</span> <span className='textrow'>0:00 ~ 18:00 (입장 마감: 17:30)</span></p>
              <p ><span className='highlight'>수, 토</span> <span className='textrow'>10:00 ~ 21:00 (입장 마감: 20:30)</span></p>
            </div>
            <hr />
