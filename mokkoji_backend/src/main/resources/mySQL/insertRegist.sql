...
-- 예약 글 정보
# INSERT INTO registedhistory(regist_code, user_id, teenager_cnt, adult_cnt, person_cnt, regist_cnt, active_date)VALUES('04RS', 'user1', 2,1, 3, 20000,'2024-10-07');
-- PK default 부재



-- 예약 페이지 이미지 정보
INSERT INTO registimages
